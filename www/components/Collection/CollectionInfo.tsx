        ...
        <div className="flex flex-col gap-2 my-6">
            {isEditing ?
                <div className="w-full md:w-2/3">
                    <input data-cy="edit-collection-name" value={tmpName} defaultValue={name} onChange={handleNameChange} className={`${kurintoBook.className} w-full text-2xl bg-transparent mt-2 py-1 border-b-2 border-b-gray-900`}></input>
