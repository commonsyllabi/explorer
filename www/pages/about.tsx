    ...
    <>
      ...
      <div className="container">
        ...
        <div>
          ...
          <p>
            This project aims to address the lack of openly browsable
            repositories of syllabi and curricula. Currently, the curricula
            designed by educators are too often locked away behind the walls of
            proprietary software and institutional accounts. Despite the fact
            that educators typically own the intellectual property rights to the
            course material they develop, there are few tools that specifically
            support the open sharing and discovery of learning materials between
            teachers.
          </p>
          <p>
          ...
          <div className="py-2">
            ...
            <ul className="d-flex flex-lg-column">
              <li className="mb-2">
                Do you want to contribute to the project, but are not sure where
                to start? <a href="mailto:team@common-syllabi.org">Email us!</a>
              </li>
              <li className="mb-2">
                If you want to keep track of the development of the project,{" "}
                <a
